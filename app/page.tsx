...
export default function ClientComponent() {
  ...
  // Smooth scroll handler for contact buttons
    ...
    <div className="min-h-screen bg-[#f4f7f9] text-slate-800 font-sans scroll-smooth">
      ...
      <header className="sticky top-0 z-50 shadow-lg flex h-16 md:h-20 bg-[#0d2344] px-4 md:px-8">
        <div className="flex items-center justify-start">
          <a href="#home" onClick={scrollToTop} className="flex items-center bg-white px-3 py-1 rounded shadow-sm hover:scale-105 transition-transform duration-300 cursor-pointer">
            <Image
              src="/mamarilogo.png"
              alt="Mamari Logo"
              width={140}
